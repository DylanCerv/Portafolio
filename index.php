						...
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									...
									-->
									<ul class="icons">
										<li><a href="https://api.whatsapp.com/send?phone=593997237902&text=Hola%20Dylan,%20Soy%20..." target="_BLANK"><img src="images/whatsapp.png" alt="Whatsapp" width="18px"></a></li>
										<li><a href="https://github.com/DylanCerv" target="_BLANK"><img src="images/GitHub.png" alt="github" width="18px"></a></li>
										<li><a href="https://www.linkedin.com/in/dylan-españa-c-200abc/" target="_BLANK"><img src="images/LinkedIn.png" alt="LinkedIn" width="18px"></a></li>
							...
							<!-- Banner -->
								<section id="banner">
									...
									<span class="image object">
										<img src="images/portada-768x432.jpg" alt="portada-768x432" />
									</span>
								</section>
							...
							<!-- Section -->
								<section>
									...
									<div class="posts">
										...
										<article>
											<a href="https://gesprender.com/" class="image" target="_BLANK"><img src="images/GesPrender.JPG" alt="" /></a>
											<h3>GesPrender</h3>
											<div class="technologies">
												<img id="technologies" src="images/php.png" alt="PHP">
												<img id="technologies" src="images/mysql.png" alt="MySQL">
												...
												<img id="technologies" src="images/Postman.png" alt="Postman">
												<img id="technologies" src="images/Jquery.png" alt="Jquery">
											</div>
											<p>Una plataforma para gestion de grandes como pequeños emprendimiento.  (En Mejoras)</p>
											<ul class="actions">
												<li><a href="https://gesprender.com/" target="_BLANK" class="button">More</a></li>
											</ul>
										</article>
										<article>
						...
						<div class="inner">
							...
							<!-- Section -->
								<section class="skills" id="skills">
									...
									<p>Puedes enviarme un mensaje, ya sea para encargar un proyecto, para contratarme, sugerir alguna mejora o incluso saludarme. <img id="happy" src="images/happy.png" alt="Happy" width="14px"></p>
									<ul class="contact">
										<li class="icon solid fa-envelope"><a href="#">gownerbeats@gmail.com</a></li>
									</ul>
									<ul class="contact">
										<li class="icon solid fa-phone"><a href="#">+593 997237902</a></li>
									</ul>
									<!-- <form method="post">
										<div>
